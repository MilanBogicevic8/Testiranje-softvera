...
public class ShuffleGame extends JFrame implements ActionListener
{
    ...
    public static int[] matrix ;//matrica susedstva
    
    private JButton[] buttonA ;//dugmici
    ...
    private AnimatedJButton button2;
    ...
    private static final int DEFAULT_LEVEL = 4 ;//pravi se sa 4 nivoom u mainu
    ...
    private static ShuffleGame shuffleGame_ ;//pokazivac na igru
    
    /** Creates a new instance of ShuffleGame */
    public ShuffleGame( int levl )//konstruktor kreira novu igru
    {
        super("ShuffleGame") ;
        random = new Random() ;
        level = levl ;
    ...
    public static void run( int level ){ //zove se pri pokretanju igre
    ...
    public void init( int num )//inicijalizacija gridLayouta,zovemoIzKonstruktora
    {
        level = num ;
        ...
        emptyLabel = new JLabel() ;//praznaLabelaZaPolje bez dugmeta
        emptyLabel.setBorder( new SoftBevelBorder( BevelBorder.LOWERED ) ) ;
    }
    
    public JPanel initilizeButtonPanel( int levl )//inicijalizacija dugmica i izbr pivot elementa
    {
        level = levl ;
        noOfMoves = 0 ;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if ( actionCommand.equals( NUMBER ) ||flag1 )
        {
            ...
            if( label != null )
            {
                ...
                repaintPanel() ;
                if( blankPosition == noOfCells - 1 || flag1)
                {
                    if( analyseResult() || flag1)
                    {
	...
	public SecondsCounter getSecondsCounter_() {
		return secondsCounter_;
	}

	public void setSecondsCounter_(SecondsCounter secondsCounter_) {
		this.secondsCounter_ = secondsCounter_;
	}


	public JMenuItem getReStartAction() {
		return reStartAction;
	}


	public static ShuffleGame getShuffleGame_() {
		return shuffleGame_;
	}

	public static void setShuffleGame_(ShuffleGame shuffleGame_) {
		ShuffleGame.shuffleGame_ = shuffleGame_;
	}
	...
	public void setAnnimatedJButton(AnimatedJButton a) {
		this.button2=a;
	}
	...
	public void setBlankPosition(int blank) {
		this.blankPosition=blank;
	}
